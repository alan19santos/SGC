...
class CondominiumRepository extends  BaseRepository {
    ...
    private $tower;
    private $ap;
    private array $relationships = ['towers', 'apartments', 'occurrences', 'residents', 'fines', 'company'];
    ...
    public function getAll(): Collection {
        return $this->loadRelationships($this->condominium, $this->relationships)->get();
    }
    ...
    {
        return $this->loadRelationships($this->condominium, $this->relationships)->findOrFail($id);
    }
    ...
    {
        return $this->loadRelationships(parent::findWhere($column, $value), $this->relationships);
    }
